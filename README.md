...
`whois-check` is for Intel processor x86-64 based and `whois-check-arm64` is for Apple Silicon based.

```
whois-check v2.2a
Last Update: 29 Apr 2024, Alex Yang (https://linkedin.com/in/4yang)
